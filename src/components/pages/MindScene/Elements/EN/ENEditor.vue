<template>
  <div class="">
    ...
    <!-- Effect Node Editor -->
    <div v-if="ENObj.userData.node.nid === eNode.nid" :key="eNode.nid" v-for="(eNode, iNode) in nodes">
      <div class="editor-area" v-if="ENObj">
        <button v-if="!node.isEntry" @click="removeCurrentBox({ node: ENObj.userData.node, nodes, mesh: ENObj, iNode })">Remove me</button>
