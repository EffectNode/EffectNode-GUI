...
THREE.TrackTrack = function ( object, domElement ) {
		...
		switch ( event.deltaMode ) {
			...
			default:
				if (event.ctrlKey) {
					...
					_panEnd.y += -event.deltaY * 0.00025;
				}
...
THREE.TrackTrack.prototype = Object.create( THREE.EventDispatcher.prototype );
THREE.TrackTrack.prototype.constructor = THREE.TrackTrack;
