        ...
        return [
          {
            ...
            equations: {
              x1: 'r * cos(k * pi2 * i / n * scale) * cos(pi2 * i / n * scale)',
              y1: 'r * cos(k * pi2 * i / n * scale) * sin(pi2 * i / n * scale)',
              z1: '0',

              x2: '1.5 * r * cos(k * pi2 * i / n * scale) * cos(pi2 * i / n * scale)',
              y2: '1.5 * r * cos(k * pi2 * i / n * scale) * sin(pi2 * i / n * scale)',
              z2: '0'
            },
            group: 3,
            dynamic: false
